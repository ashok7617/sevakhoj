...
export function MhBocwForm({ profile, configured, signedIn, error }: { profile: Profile | null; configured: boolean; signedIn: boolean; connectedVia?: string; error?: string }) {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      ...
      <p className="mt-1 max-w-2xl text-sm text-slate-600">Same saved profile, a different state&apos;s form. Your details flow into MahaBOCW too; review the generated form and submit on mahabocw.in.</p>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1fr)]">
        ...
        <div>
          ...
          <SubmitSteps
            portalName="mahabocw.in"
            portalUrl="https://mahabocw.in/"
            applyLabel="worker registration (कामगार नोंदणी)"
            docs="Aadhaar, bank passbook, and proof of 90+ days' construction work (employer / contractor certificate or self-declaration)"
            csc="any CSC / Aaple Sarkar Seva Kendra"
          />
        </div>
      </div>
    </div>
